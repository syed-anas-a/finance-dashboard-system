...
public class AuthService {
	...
	public Map<String, Object> handleLogin(LoginRequest loginRequest) {
		...
		authManager.authenticate(userCredentials);
		
		User user = userRepository.findByUsername(loginRequest.getUsername())
				.orElseThrow(() -> new RuntimeException("User not found"));
		
		return Map.of("message", "Login Successfull", "user", user.getUsername(), "role", user.getRole());
	}
